...
import dev.lounres.kone.misc.planimetricsCalculation.calculate
import dev.lounres.kone.misc.planimetricsCalculation.collinearityCondition
import dev.lounres.kone.misc.planimetricsCalculation.concurrencyCondition
...
//    println()
    ...
    calculate {
        val condition1 = desarguesTheoremConcurrencyCondition * collinearityCondition(A1, B1, C1) * collinearityCondition(A2, B2, C2)
        val condition2 = desarguesTheoremCollinearityCondition
